...
spark = SparkSession.builder.appName("query5-sql-b").getOrCreate()
...
sqlString = \
        ...
        "(select ratings._c0 as user, ratings._c1 as id, movie_genres._c1 as genre, movies._c1 as movie, ratings._c2 as rating,float(movies._c7) as popularity " +\
        "from ratings, movies, movie_genres " +\
        "where ratings._c1 = movies._c0 and movies._c0 = movie_genres._c0 " +\
        "order by user desc, rating desc, float(popularity) desc) as Table1, " +\
        "(select ratings._c0 as user, ratings._c1 as id, movie_genres._c1 as genre, movies._c1 as movie, ratings._c2 as rating, float(movies._c7) as popularity " +\
        "from ratings, movies, movie_genres " +\
        "where ratings._c1 = movies._c0 and movies._c0 = movie_genres._c0 " +\
        "order by user desc, rating desc, float(popularity) desc) as Table3 " +\
